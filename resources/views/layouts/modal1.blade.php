    ...
    <form  method="post" action="/send-groceries-email">
        ...
        {{-- <div class="accordion" id="accordionExample">
            <div class="card">
              ...
              <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                <div class="card-body">
                 <textarea name="bread" id="" cols="4" placeholder="Unesite željenu/e vrste hljeba."></textarea>
                </div>
              </div>
            </div>
            ...
            <div class="card">
              ...
              <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                <div class="card-body">
                    <textarea name="milk" id="" cols="4" placeholder="Unesite željenu/e vrste mlijeka."></textarea>  
                </div>
               </div>
            </div>
             <div class="card">
              ...
              <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
                <div class="card-body">
                    <textarea name="yogurt" id="" cols="4" placeholder="Unesite željenu vrstu jogurta (Proizvođač, masnoća...)"></textarea> 
                </div>              
              </div>
            </div>
            <div class="card">
                ...
                <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordionExample">
                  <div class="card-body">
                      <textarea name="papers" id="" cols="4" placeholder="Unesite željenu/e novine."></textarea>      
                  </div>         
                </div>
              </div>
        </div> 
      ...
      <div class="personalInfo">
          <div>
              ...
              <input name="phone" type="text" placeholder="Broj telefona">
          </div>
          <div>
              <input name="adress" type="text" placeholder="Adresa">
          ...
          <div class="ordertime">
              <div>
                <span>OD: </span>
                <select id="choosedTime" name="time"  onclick="change()">
